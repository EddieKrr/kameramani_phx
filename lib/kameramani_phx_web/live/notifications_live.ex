  ...
  def render(assigns) do
    ...
    >
      ...
      <div
        ...
        class="absolute right-0 z-50 mt-3 w-[24rem] overflow-hidden rounded-[28px] border border-white/10 bg-[#0d1016]/95 shadow-[0_24px_70px_rgba(0,0,0,0.48)] backdrop-blur-xl lg:w-[27rem]"
      >
