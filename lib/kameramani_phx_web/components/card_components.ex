defmodule KameramaniPhxWeb.CardComponents do
  ...
  def card(assigns) do
    ...
    <article>
      <div class="relative aspect-video w-full bg-gradient-to-tl from-black to-slate-700 hover:scale-110 hover:z-50 hover:shadow-2xl transition-all duration-300 ease-in-out">
