              ...
              <tr class="hover:bg-blue-50/50 transition-colors group">
                ...
                <td class="py-4 px-6">
                  <%= if Map.get(user, :is_live) do %>
                    <span class="rounded-full bg-green-400 border-2 border-green-200 uppercase animate-pulse px-3 py-1">
                      live
                    </span>
                  <% else %>
                    <span class="rounded-full text-xs bg-gray-300 border-2 border-red-100 uppercase px-2 py-1">
                      offline
                    </span>
                  <% end %>
                </td>
          ...
          <div class="flex justify-between items-start mb-6">
            <div>
              <div class="flex items-center gap-2 mb-1">
                ...
                <span class="bg-purple-100 text-purple-700 py-0.5 px-2 rounded-md text-xs font-bold uppercase tracking-wider">
                  System
                </span>
              </div>
