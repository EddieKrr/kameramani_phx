defmodule KameramaniPhx.MixProject do
  use Mix.Project
  ...
  defp deps do
    ...
    # {:membrane_rtmp_server_plugin, "~> 0.7.1"},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind kameramani_phx", "esbuild kameramani_phx"],
      "assets.deploy": [
        "tailwind kameramani_phx --minify",
        "esbuild kameramani_phx --minify",
        "phx.digest"
      ],
